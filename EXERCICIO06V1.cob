...
EXER02         88 SW-FIM-SIM                 VALUE 'S'.
      ***************************CABECALHO RELATORIO*******************
       01  LINE-DESIGN             PIC X(53)
               VALUES
               '*===================================================*'.
      * 01  WCA-TITULO              PIC X(40) VALUES
      *                '*RELATORIO MENSAL DO BANCO'.
       01  WCA-SUBTITULO            PIC X(53) VALUES
...
EXER05     05 FILLER               PIC X(40) VALUES
...
EXER04 01 CABECALHO.
EXER04     05 WCA-CODIGO           PIC X(08) VALUES '  CODIGO'.
EXER04     05 FILLER               PIC X(07) VALUES SPACES.
EXER04     05 WCA-CONTA            PIC X(14) VALUES ' TIPO DA CONTA'.
EXER04     05 FILLER               PIC X(09) VALUES SPACES.
EXER04     05 WCA-SALDO            PIC X(15) VALUES 'SALDO DA CONTA'.

EXER04 01 WSA-SAIDA.
EXER05     05 FILLER               PIC X(3)  VALUES SPACES.
EXER04     05 S01-COD-CTA          PIC 9(4)  VALUES ZEROS.
EXER04     05 FILLER               PIC X(8)  VALUES SPACES.
EXER04     05 S01-TIP-CTA          PIC X(14).
EXER04     05 FILLER               PIC X(09) VALUES SPACES.
EXER04     05 FILLER               PIC X(4)  VALUE 'R$  '.
